...
import aliyar.mostafa.project.objects.view.StudentMenu;
import aliyar.mostafa.project.objects.view.TeacherMenu;
...
public class PersonController {
    ...
    public static void questionForChange(boolean status, Scanner scanner, Persen[] persen) {
        System.out.println(Massage.PERSON_MENU_DU.getMessage());
        switch (scanner.nextInt()) {
            case CODE_MELI:
                System.out.println(Massage.GET_COD_MELI_PERSON.getMessage());
    ...
    public static void createStudent(int index, Scanner scanner) {
    ...
    public static void createTeacher(int index, Scanner scanner) {
        System.out.println(Massage.LINE.getMessage());
        ...
        int day=scanner.nextInt();
        Date date = new Date(year,month,day);
        teachers[index]=new Teacher(name,codMeli,date);
